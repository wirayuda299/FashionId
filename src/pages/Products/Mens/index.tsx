			...
			<div className='container mx-auto flex px-5 py-24 items-center justify-center flex-col'>
				...
				<div className='text-center lg:w-2/3 w-full'>
					...
					<p className='mb-8 text-gray-600 text-sm sm:text-base'>
						Elevate your style game with our collection of fashionable men's
						apparel. From sleek suits to trendy streetwear, we've got you
						covered with the latest styles and trends. Whether you're heading to
						the office or hitting the town, our selection of stylish clothes
						will help you make a statement. Be a fashion hero with our curated
						collection of men's fashion
					</p>
