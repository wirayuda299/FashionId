      ...
      <div className='container mx-auto flex px-5 py-24 items-center justify-center flex-col'>
        ...
        <div className='text-center lg:w-2/3 w-full'>
          ...
          <p className='mb-8 text-gray-600 text-sm sm:text-base'>
            Step up your style game with our
            newest line of fashionable clothing
            for women. From trendy tops and
            dresses to stylish pants and skirts,
            we've got you covered for any
            occasion. Whether you're looking for a
            statement piece to elevate your
            everyday wardrobe or something chic
            and elegant for a special event, our
            selection of high-quality fabrics and
            attention to detail will have you
            looking and feeling your best. Don't
            miss out on the chance to upgrade your
            closet shop now and make a fashion
            statement that's all your own.
          </p>
