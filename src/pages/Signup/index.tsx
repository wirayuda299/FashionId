            ...
            <form
              ...
              <div className='mb-2 w-full'>
                ...
                {errors.email?.type ===
                  'maxLength' && (
                    <p className='text-xs pt-1 text-red-700'>
                      Max charachters on email input
                      is 90
                    </p>
                  )}
                {errors.email?.type ===
                  'pattern' && (
                    <p className='text-xs pt-1 text-red-700'>
                      Add correct email pattern,
                      email cannot contain
                      whitespaces and must include @
                    </p>
                  )}
              </div>
              <div className='mb-2'>
              ...
              <div className='mt-6'>
                <button
                  className={`w-full px-4 py-2 rounded-md tracking-wide text-white transition-colors duration-200 transform bg-[#0000008c] hover:bg-[#000] ${processing
                    ? 'cursor-wait'
                    : 'cursor-pointer'
                    }`}
                  type='submit'>
