  ...
  return (
    <div className='w-full h-full flex justify-center '>
      <div className='max-w-3xl h-[500px] flex justify-center items-center flex-col'>
        ...
        <form className='flex justify-center items-center flex-col' onSubmit={handleSubmit(handleSubscribe)}>
          <input className=' w-80 md:w-96 text-slate-500 py-4 bg-transparent focus:border-slate-400 focus:outline-none rounded-lg placeholder:text-slate-500 border pl-5' type='email' placeholder='Enter your email...'
          ...
          <button type='submit' className='bg-[#000000e7] transition-all ease-out duration-300 py-2 px-5 rounded-md mt-3 text-white hover:bg-[#000]'>
            Subscribe
          </button>
        </form>
      </div>
