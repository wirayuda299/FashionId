	...
	return (
		<div className='w-full h-full max-w-6xl mx-auto '>
			<div className='w-full h-full '>
				<h2 className='text-xl sm:text-3xl md:text-4xl text-center font-extrabold py-14 uppercase text-black topSelling-title '>
				...
				<div className='container mx-auto flex overflow-x-auto justify-center gap-2 pb-5'>
					{data?.map((product: Products) => (
						<div key={product?._id} className='mb-5'>
							<div className='bg-[#ebebeb] w-24 sm:w-28 px-3 sm:px-5 py-2  sm:py-3 text-center rounded-lg text-black uppercase sm:font-semibold text-xs'>
								{product?.category}
							</div>
						</div>
					))}
