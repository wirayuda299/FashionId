...
const MensProducts = lazy(
	async () => await import('../pages/Products/Mens/Products')
);
const LadiesProduct = lazy(
	async () => await import('../pages/Products/Ladies/Products')
);
...
const CatalogSearchResult = lazy(
	async () => await import('../pages/CatalogSearch')
);
